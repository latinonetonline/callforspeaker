...
const PersonalInformation: React.FC<PersonalInformationProps> = () => {
  ...
  const handleCanNavigate = (): boolean => {
    return isValid;
  };
  ...
  return (
    <>
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(onValidSubmit)} ref={refFrom}>
          ...
          <div className="navigation-buttons_container button_container">
            <div className="navigation-btn_container">
              <PrevButton />
              <NextButton canNavigate={handleCanNavigate} />
            </div>
          </div>
        </form>
      </FormProvider>
